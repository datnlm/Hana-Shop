...
public class ViewHistoryController extends HttpServlet {
    ...
    public static final String URL = "viewHistory.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<OrderDTO> list = dao.getOrder(user.getUserID(), productName, date);
            if (list.isEmpty()) {
                request.setAttribute("ERROR", "Nothing in orders");
            } else {
